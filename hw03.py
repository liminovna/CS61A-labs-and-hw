...
def num_eights(pos):
    ...
    if last == 8:
        return 1 + num_eights(new_pos)
    elif new_pos == 0:
        return 0
    elif last != 8:
        return num_eights(new_pos)
...
def missing_digits(n):
    ...
    def helper(last, n2):
        if n2 == 0:
            return 0
        elif n2 % 10 == last - 1 or n2 % 10 == last:
            return helper(n2 % 10, n2 // 10)
        else:
            return 1 + helper(last-1, n2)
