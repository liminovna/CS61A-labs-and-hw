class VendingMachine:
    ...
    def restock(self, amount):
        ...
        return f'Current {self.item} stock: {self.items_left}'
    ...
    def vend(self):
        ...
        diff = abs(self.price - self.funds)
        if self.funds < self.price:
            ...
            if diff == 0:
                ...
                return f'Here is your {self.item} and ${diff} change.'
...
class Coin:
    ...
    def worth(self):
        return self.price + (self.present_year - 50)
...
def store_digits(n):
    ...
    if n%10 == 0:
        return n
    return Link(store_digits(n//10), n%10)
